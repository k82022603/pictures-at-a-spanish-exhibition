...
SHARED = {
    "유효 사진 장수": "244",   # **2026-08-23 확정.** 보정본 넷을 지워 파일 수와
    #                          고유 장면 수가 같아졌다. 이제 어떻게 세도 244 다.
    #                          세는 것은 `사진목록.py` 가 한다 — 픽셀 닮음과
    #                          EXIF 「마지막으로 만든 프로그램」 **둘 다** 본다.
    #                          옛 값 253 · 248 · 245 는 각 문서의 원문에 R3 로
    #                          남아 있고, 왜 바뀌었는지는 `00` 실사 절의 개정.
    #  (버린 주석) 원래 실사값. 2026-08-12 에 축소본 5장을 지워 파일은 248,
